...
class TournamentListTest(TestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse('officer_list', kwargs={'tournament_pk': self.tournament.pk})


    def test_club_list_url(self):
        self.assertEqual(self.url,f'/tournament/officer_list/{self.tournament.pk}/')
