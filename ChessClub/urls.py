...
urlpatterns = [
    ...
    path('tournament/<str:tournament_pk>/apply/',views.sign_up_tournament, name='sign_up_tournament'),
    path('tournament/<str:tournament_pk>/cancel/',views.cancel_sign_up_tournament, name='cancel_sign_up_tournament'),
    path('tournament/<str:tournament_pk>/officers/',views.officer_list, name='officer_list'),
    path('tournament/<str:tournament_pk>/co-organisers/',views.co_organiser_list, name='co_organiser_list'),
    path('tournament/<str:tournament_pk>/officers/allow_co-organiser/<int:user_id>/',views.allow_co_organiser, name='allow_co_organiser'),
    path('tournament/<str:tournament_pk>/co-organisers/remove/<int:user_id>/',views.remove_co_organiser, name='remove_co_organiser'),
]
