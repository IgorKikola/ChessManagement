...
urlpatterns = [
    ...
    path('club/<str:club_pk>/tournament/<str:tournament_pk>/matches/', views.show_matches, name='scheduled_matches'),
    path('club/<str:club_pk>/tournament/<str:tournament_pk>/matches/schedule', views.schedule_matches, name='schedule_matches')
]
