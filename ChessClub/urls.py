...
urlpatterns = [
    ...
    path('member_manage_club/<str:pk>/', views.member_manage_club, name='member_manage_club'),
    path('applicant_manage_club/<str:pk>/', views.applicant_manage_club, name='applicant_manage_club'),
    ...
    path('member_manage_club_list/', views.member_manage_club_list, name='member_manage_club_list'),
    path('applicant_manage_club_list/', views.applicant_manage_club_list, name='applicant_manage_club_list'),
